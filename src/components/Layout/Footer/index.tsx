  ...
  return (
    <>
      ...
      <div className="px-4 md:px-8 2xl:px-0 relative mx-auto max-w-c-1440 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
        <div>
          <a href='/'><img src="/images/logo/logo.png" alt="logo" className='w-44' /></a>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-5">
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Web Development</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Pricing</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Support</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Client Portal</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Resources</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-5 mt-6 max-sm:hidden">
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>FAQ</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Partners</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Sitemap</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Contact</a>
            </li>
            <li>
              <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>News</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="px-4 md:px-8 2xl:px-0 relative mx-auto max-w-c-1440 flex flex-wrap max-md:flex-col gap-4">
        <ul className="md:flex md:space-x-6 max-md:space-y-2">
          <li>
            <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Terms of Service</a>
          </li>
          <li>
            <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Privacy Policy</a>
          </li>
          <li>
            <a href='/' className='hover:text-fta-primary-800 text-fta-primary-700 text-sm'>Security</a>
          </li>
        </ul>
