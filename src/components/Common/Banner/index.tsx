...
export default function BannerInIndex({ banners }: { banners: Banner[] }) {
	...
	return (
		<div className="relative w-full h-auto bg-fta-primary-50 flex flex-col md:flex-row">
			...
			{/* 文字和按钮 */}
			<div className="md:w-2/5 p-6 md:p-18 flex flex-col z-10">
				...
				<div className="space-x-4">
					<button className="text-white w-full md:w-1/3 bg-fta-primary-400 hover:bg-fta-primary-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-4 py-2 text-center">
						Sign Up
					</button>
				</div>
			</div>
