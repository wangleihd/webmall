						...
						<form className="bg-white max-w-xl w-full mx-auto shadow-md p-4 md:p-16 rounded-2xl">
							...
							<div>
								...
								<div className="relative flex items-center">
									<input name="name" type="text" required className="w-full bg-transparent text-sm text-gray-800 border-b border-gray-300 focus:border-fta-primary-400 px-2 py-3 outline-none" placeholder="Enter name" />
