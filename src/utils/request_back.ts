// import useUserStore from '@/stores/useUserinfoStroe';
import useUserStore from '@/stores/useUserinfoStroe';
...
// const showLoading = (option: { target: null | HTMLElement }): void => {
...
//   if (activeAxios <= 0) {
//     clearTimeout(timer);
//     loadingInst nce && loadingInstance.close();
//   }
// };
...
service.interceptors.response.use(
  (response: axios.AxiosResponse): axios.AxiosResponse => {
    const userStore = useUserStore();
